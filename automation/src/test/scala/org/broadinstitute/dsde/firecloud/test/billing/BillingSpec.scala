...
/**
  ...
  */
class BillingSpec extends FreeSpec with WebBrowserSpec with Matchers with LazyLogging
  with UserFixtures with BillingFixtures with WorkspaceFixtures with CleanUp {

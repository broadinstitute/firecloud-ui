...
import org.broadinstitute.dsde.workbench.fixture.FailedTestRetryable
...
/**
  ...
  */
class RegistrationSpec extends FreeSpec with FailedTestRetryable with BeforeAndAfter with Matchers with WebBrowserSpec with UserFixtures {

  ...
  "A user" - {
    ...
    "who owns a workspace" - {
      ...
      "should be able to correctly delete workspace attributes" - {
        ...
        "page should correctly render gcs links" in withWebDriver { implicit driver =>
          val user = UserPool.chooseStudent
          implicit val authToken: AuthToken = user.makeAuthToken()
        ...
        "page should correctly render dos links" in withWebDriver { implicit driver =>
          val user = UserPool.chooseStudent
          implicit val authToken: AuthToken = user.makeAuthToken()
        ...
        "page should not link if its not a gcs or dos link" in withWebDriver { implicit driver =>
          val user = UserPool.chooseStudent
          implicit val authToken: AuthToken = user.makeAuthToken()
        ...
        "preview should work correctly for gcs link" in withWebDriver { implicit driver =>
          val user = UserPool.chooseStudent
          implicit val authToken: AuthToken = user.makeAuthToken()
        ...
        "preview should display correct message when file not previewable" in withWebDriver { implicit driver =>
          val user = UserPool.chooseStudent
          implicit val authToken: AuthToken = user.makeAuthToken()
        ...
        "preview should display correct message when file not accessible for dos:// link" in withWebDriver { implicit driver =>
          val user = UserPool.chooseStudent
          implicit val authToken: AuthToken = user.makeAuthToken()

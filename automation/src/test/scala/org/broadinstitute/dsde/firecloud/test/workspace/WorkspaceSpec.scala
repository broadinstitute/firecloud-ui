...
import org.broadinstitute.dsde.firecloud.fixture.{MethodData, MethodFixtures, TestData, WorkspaceFixtures, UserFixtures}
...
class WorkspaceSpec extends FreeSpec with WebBrowserSpec with WorkspaceFixtures with UserFixtures with MethodFixtures
  ...
  "A user" - {
    ...
    "who has reader access to workspace" - {
      ...
      "should see launch analysis button disabled" taggedAs Tags.GooglePassing in withWebDriver { implicit driver =>

...
/**
  ...
  */
class AlphaSmoketestSpec extends FreeSpec with WebBrowserSpec with Matchers with WorkspaceFixtures with BillingFixtures with WebDriverIdLogging with TestReporterFixture with CleanUp with UserFixtures
  with MethodFixtures with LazyLogging  {
  ...
  "User should be able to create and delete a cluster" in {

...
if [ $ENV = "alpha" ]; then
    launchSubmission harry.potter@test.firecloud.org perf-test-a Perf-test-A-workspace abcd no_sleep1hr_echo_files sample_set sample_set22k true "this.samples"
    ...
    sleep 2m
    launchSubmission ron.weasley@test.firecloud.org perf-test-b Perf-Test-B-W abcd no_sleep1hr_echo_files sample_set sample_set22k true "this.samples"
    ...
    sleep 1m
    launchSubmission mcgonagall.curator@test.firecloud.org perf-test-d Perf-Test-D-W_copy abcd no_sleep1hr_echo_files sample_set sample_set22k true "this.samples"
    ...
    sleep 2m
    launchSubmission draco.malfoy@test.firecloud.org perf-test-e Perf-Test_F_W abcd no_sleep1hr_echo_files sample_set sample_set22k true "this.samples"
    ...
    sleep 1m
    launchSubmission hermione.owner@test.firecloud.org aa-test041417 Perf-Test-G-W abcd no_sleep1hr_echo_files sample_set sample_set22k true "this.samples"

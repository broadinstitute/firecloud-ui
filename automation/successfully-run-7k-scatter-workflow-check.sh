...
launchSubmission dumbledore.admin@test.firecloud.org cromwell-tests-billing-project cromwell-tests-workspace wide-scatter-testing wide_scatter "" "" true false ""
findSubmissionID dumbledore.admin@test.firecloud.org cromwell-tests-billing-project cromwell-tests-workspace wide-scatter-testing wide_scatter

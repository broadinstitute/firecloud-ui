     ...
     [modals/OKCancelForm
      {:header [:div {:style {:lineHeight 1.3}}
       ...
       [:div {}
        ...
        (this :-render-checkbox "Aggregate analysis to understand variation in the general population" :code :aggregates)
        (this :-render-checkbox "Study population origins or ancestry" :code :poa)

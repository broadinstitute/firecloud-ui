                       ...
                       (common/render-info-box
                        {:position "top"
                         :text (react/create-element
                                [:span {}
                                 [:div {:style {:paddingBottom "1rem"}} "Let's say you have a \"Sample 1\" with " [:var {} "Participant 1"] " and " [:var {} "Gender"] " attributes already set in Workspace A, and you want to copy just the sample data over to Workspace B. Workspace B already has the " [:var {} "Participant 1"] " and " [:var {} "Gender"] " attributes set, so if you tried to copy over \"Sample 1\", Workspace B would tell you you have a conflict because " [:strong {} "copying"] " brings over all the attributes (" [:var {} "Participant 1"] " and " [:var {} "Gender"] ") with the sample data."]
                                 [:div {} "Instead, you'll want to click re-link. This copies over the \"Sample 1\" data into Workspace B " [:strong {} "without"] " bringing along any attributes that were tied to it in Workspace A. Be aware that " [:var {} "Participant 1"] " may not be the same participant in Workspace A & B or they could be the same but have different versions of attributes."]])})]])]

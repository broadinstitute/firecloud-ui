          ...
          (cond
            ...
            (if (empty? billing-accounts)
              ...
              [:div {:style {:width 750}
               ...
               [:div {:style {:fontSize "80%" :fontStyle "italic"}} "To grant FireCloud access to an account, enter its console and add terra-billing@terra.bio as a Billing Account User."]
